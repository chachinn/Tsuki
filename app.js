...
const APP_CACHE_NAME = "tsuki-cache-v1-pre-cloud-backup-12";
...
const RELEASE_NOTES = [
  { icon: "☁️", title: "Optional Cloud Backup", text: "Signed-in users can explicitly opt in to Firebase backup with latest-seven history, restore preview and cloud deletion. Signing in alone never uploads health data." },
