...
const APP_CACHE_NAME = "tsuki-cache-v1-pre-plans-events-13";
...
const RELEASE_NOTES = [
  { icon: "🗓️", title: "Plans & Events Intelligence", text: "Birthdays, parties, weddings, concerts, dates, appointments, out-of-town days and travel can now be logged and checked against cycle or Pregnancy timing without turning uncertainty into a diagnosis." },
